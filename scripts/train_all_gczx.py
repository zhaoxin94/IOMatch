...
if __name__ == '__main__':
    ...
    parser.add_argument("--method", "-m", default="scomatch", help="Method")
    ...
    # base directory
    base_dir = osp.join('output/gczx', args.method, str(args.num_labels),
    ...
    for i in range(args.n_trials):
        ...
        os.system(
            ...
            f'--c config/openset_cv/{args.method}/{args.method}_gczx_{args.num_labels}.yaml'
        )
