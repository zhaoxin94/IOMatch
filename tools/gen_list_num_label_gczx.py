...
class_list = ['Background', 'Cutting', 'Drilling', 'Shaking', 'Hammering', 'Knocking', 'Patting']
...
labels = []
with open('data/gczx/filelist/train.txt', "r") as f:
...
with open('data/gczx/filelist/train.txt', "r") as f0:
    with open(f'data/gczx/filelist/train_labeled_{int(n_share*label_per_class)}.txt', "w") as f1:
        with open('data/gczx/filelist/val.txt', "w") as f2:
            with open(f'data/gczx/filelist/train_unlabeled_{int(n_share*label_per_class)}.txt', "w") as f3:
