...
def get_gczx(args, alg, name, labeled_percent, num_classes, data_dir='./data'):
    ...
    lb_dset = GCZXDataset(root=os.path.join(data_dir, "gczx"),
    ...
    ulb_dset = GCZXDataset(
        root=os.path.join(data_dir, "gczx"),
        transform=transform_weak,
        is_ulb=True,
        alg=alg,
    ...
    test_dset = GCZXDataset(root=os.path.join(data_dir, "gczx"),
                            transform=transform_val,
                            is_ulb=False,
                            alg=alg,
...
class GCZXDataset(BasicDataset):
    def __init__(self,
                 root,
                 transform,
                 is_ulb,
                 ...
                 flist=None):
        super(GCZXDataset, self).__init__(alg=alg,
                                          data=None,
                                          is_ulb=is_ulb,
                                          transform=transform,
